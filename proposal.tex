...
Pour remplir cet objectif, nous allons avoir besoin de plusieurs niveau de langages afin de traiter les différents niveaux de représentation d'un tricot (du descriptif aux instructions). Nous présentons ici ces langages ainsi que les composants du logiciel qui vont les manipuler.

\subsubsection{Cinq différents niveaux de langages}

Afin de remplir ses objectifs, notre logiciel va mabipuler en tout cinq langages, ou aparentés, de description des tricots. Nous décrivons ici ces cinq niveaux :

\begin{itemize}
 \item \textbf{Les spécifications utilisateur.} Au niveau de l'interface graphique, l'utilsateur pourra entrer les spécifications du tricot qu'il souhaite réaliser (forme, taille,...). En pratique, ce langage comprendra en particulier une énumération des objets à tricoter (pull, bonnet, gant...), des differents motifs disponibles avec leur position sur le tricot, et aussi la possibilité de donner des indications spatiales, comme la taille du tricot. Ainsi, une phrase dans ce langage consiste en une liste des propriétés du tricot souhaité.
 ...
 \item \textbf{Une représentation intermédiaire.} Lors de la compilation du langage descritif vers les instructions maille par maille, le compilateur utilisera une représentation intermédiaire. Celle-ci se fera sous forme de graphe. Les noeuds représenteront les mailles, tandis que les arêtes représenteront la manière dont elles sont reliées entre elles.
...
La figure \ref{nvx-lg} représente ces niveaux de langages et leurs liens respectifs. %A REFORMULER
