...
En outre la réflexion sur la manière d'intégrer les tresses (version 3) à ce langage a été entammée. %Ici : détails


\subsection{Compilateur}

%Pas super bien formulée cette partie

Contrairement à nos prévisons le compilateur n'est pas encore fonctionnel. Ceci est dû au fait d'avoir abandonné la représentation intermédiaire surlaquelle nous avions travaillé au début.
