...
La communication au sein du projet était un point important pour avoir une avancée régulière. 
Cette communication a été facilitée par la liste \texttt{tricomp@listes.ens-lyon.fr}, par les 
séances régulières, mais également les séances non officielles où certains groupes se réunissaient 
afin de résoudre certaines problématiques plus coriaces (notamment par rapport au langage, au 
compilateur et à la gestion de l'éditeur de l'interface).
