...
La figure \ref{langage} illustre et résume les possibilités du langage.
\begin{figure}[!ht]
	\centering
	...
	\end{tikzpicture}
	\label{langage}
	\caption{Les possibilités du langage illustré sur un tricot (en l'occurence un poncho). Une attention toute particulière est portée aux jonctions entre les différents trapèzes.}
\end{figure}
