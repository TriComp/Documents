...
\frame{
	\frametitle{Les instructions de tricot}
		\begin{itemize}
			...
			\onslide<6-> \item Des instructions longues et compliquées à établir
			\onslide<7-> \item Dans les manuels de tricots, instructions pour un motif donné, sans tenir compte de la forme du tricot.
		\end{itemize}
}
