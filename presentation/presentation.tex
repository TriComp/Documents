...
\frame{
	\frametitle{Présentation générale}
		\begin{itemize}
			...
			\onslide<3-> \item Le tout utilisable via une interface graphique
		\end{itemize}
}
...
\frame{
	\frametitle{Motivations}
		\begin{itemize}
			\item Le tricot n'est pas très présent dans le milieu informatique...
			\item Les logiciels de tricot actuels ne proposent souvent que de l'édition
			\item De plus, ces logiciels utilisent une représentation très locale des points de tricot.
			% TODO : image 
			%\item Manuels de tricot pas faciles à suivre, ... 
			\item Un projet original !
			% TODO : autres ?
		\end{itemize}
}
