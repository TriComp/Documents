...
\frame{
	\frametitle{Un compilateur pour tricot}
		\begin{itemize}
			\item D'un patron de tricot vers une liste d'instructions
			% TODO : Ajouter un schéma 
			\item Le tout utilisable via une interface graphique
		\end{itemize}
}
...
\frame{
	\frametitle{Les instructions de tricot}
			\item Les instructions à suivre par le tricoteur comportent des informations sur :
			\begin{itemize}
